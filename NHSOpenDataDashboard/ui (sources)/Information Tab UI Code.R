         ...
         fluidRow(
           column(12,
                  ...
                  p("The NHS Open Data Dashboard for Scotland is intended to educate and inform members of the public about health related issues across the entirety of Scotland.
                    ...
                    The code will be updated regularly and commentated on throughout the development of the application. If you wish to view the github for this dashboard please head to the following ", tags$a(href="https://github.com/Benny24aa/NHS-Open-Data-Dashboard---R-Shiny", icon("github"),
                                                                                                                                                                                                                 "", target="_blank"), ), 
