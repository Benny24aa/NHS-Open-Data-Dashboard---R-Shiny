information <- tabPanel(title = "Information", 
         ...
         fluidRow(
           column(6,
                  h2("Welcome to the NHS Open Data Dashboard", style = "color:  #3F3685 ; font-weight: 600")),
         ...
         fluidRow(
           column(12,
                  ...
                  p("The NHS Open Data Dashboard for Scotland is intended to educate and inform members of the public about health related issues across the entirety of Scotland.
                    ...
                    The code will be updated regularly and commentated on throughout the development of the application. "), 
